...
public enum ErrorCode {
    ...
    USERNAME_INVALID(HttpStatus.BAD_REQUEST, "Username must be at least 3 character"),
    PASSWORD_INVALID(HttpStatus.BAD_REQUEST, "Password must be at least 8 character"),
